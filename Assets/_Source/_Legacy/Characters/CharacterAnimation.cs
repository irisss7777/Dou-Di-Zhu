...
public class CharacterAnimation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(fixPositionX ? initialPosition.x : transform.position.x, (fixPositionY ? initialPosition.y : transform.position.y) - deltaY, initialPosition.z);
        if (!isBlink)
        {
